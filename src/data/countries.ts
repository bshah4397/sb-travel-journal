...
export const COUNTRIES: Country[] = [
  ...
  },
  {
    ...
    flag: '🇫🇷',
    continent: 'Europe',
    dateVisited: '2026-06-26',
    who: 'duo',
    remote: false,
    notes:
      'Paris for Shraddha’s birthday, cake and the city lights along the Seine.',
    km: 6600,
    map: { x: 47, y: 30 },
    milestone: 'Shraddha’s birthday',
  },
  {
    id: 'belgium',
    iso: 56,
    ...
    who: 'duo',
    remote: false,
    notes: 'Brussels by night, warm waffles and the Grand-Place all lit up.',
    km: 6700,
    map: { x: 48, y: 27 },
  },
  {
    ...
    flag: '🇳🇱',
    continent: 'Europe',
    dateVisited: '2026-06-30',
    who: 'duo',
    remote: false,
    notes:
      'Amsterdam by canal boat, bicycles and gabled houses everywhere you looked.',
    km: 6350,
    map: { x: 49, y: 25 },
  },
  {
    ...
    remote: false,
    notes:
      'Our first big family trip, both sets of parents out in the Alps around Zurich and Lucerne.',
    km: 6100,
    map: { x: 49, y: 31 },
    milestone: 'First family trip',
  },
  {
    id: 'austria',
    iso: 40,
    ...
    flag: '🇦🇹',
    continent: 'Europe',
    dateVisited: '2026-08-05',
    who: 'duo',
    remote: false,
    notes: 'Vienna’s grand palaces and a long, slow coffee-house afternoon.',
    km: 5900,
    map: { x: 53, y: 29 },
  },
  {
    ...
    flag: '🇨🇿',
    continent: 'Europe',
    dateVisited: '2026-08-08',
    who: 'duo',
    remote: false,
    notes: 'Prague’s old town squares and the castle watching over the river.',
    km: 6100,
    map: { x: 53, y: 27 },
  },
  {
    ...
    flag: '🇩🇪',
    continent: 'Europe',
    dateVisited: '2026-08-12',
    who: 'shraddha',
    remote: false,
    notes: 'Shraddha’s work week in Frankfurt, evenings along the river Main.',
    km: 6100,
    map: { x: 51, y: 27 },
  },
];
